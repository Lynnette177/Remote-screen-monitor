...
ID3D11Device* UI_imgui::pd3dDevice = nullptr;
ID3D11DeviceContext* UI_imgui::pd3dDeviceContext = nullptr;
IDXGISwapChain* UI_imgui::pSwapChain = nullptr;
ID3D11RenderTargetView* UI_imgui::pMainRenderTargetView = nullptr;
...
LRESULT WINAPI UI_imgui::WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
void UI_imgui::Render()
{
    ...
    ::RegisterClassEx(&wc);
    const HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("Screen Monitor"), WS_OVERLAPPEDWINDOW, 100, 100, 50, 50, NULL, NULL, wc.hInstance, NULL);
